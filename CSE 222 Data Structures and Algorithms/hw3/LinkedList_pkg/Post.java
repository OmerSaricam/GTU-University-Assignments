...
public class Post {
    ...
    /** An LinkedList of Like objects representing the users who have liked this post. */
     ...
     */    
    public int getLike_number(){ return likes.size(); }

    /**
     * Returns an LinkedList of Like objects representing the users who have liked this post.
     * 
     * @return An LinkedList of Like objects representing the users who have liked this post.
     */
     ...
     */
    public int getComment_number(){ return comments.size(); }

    /**
     * Returns an LinkedList of Comment objects representing the comments on this post.
     * 
     * @return An LinkedList of Comment objects representing the comments on this post.
     */
    public LinkedList<Comment> getComment(){ return comments; }
