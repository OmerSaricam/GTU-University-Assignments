...
public class Account {
    ...
    /**
     * An arraylist of Post objects representing the posts made by the account holder.
     */
    ...
    /**
     * An arraylist of Account objects representing the accounts followed by the account holder.
     */
    ...
    /**
     * An arraylist of Account objects representing the accounts following the account holder.
     */
    ...
    /**
     * An arraylist of Message objects representing the messages received by the account holder.
     */
    ...
    /**
     * An arraylist of Message objects representing the messages sent by the account holder.
     */
    ...
    /**
     * An arraylist of Account objects representing the accounts blocked by the account holder.
     */
    private ArrayList<Account> blocked_users = new ArrayList<Account>();
    ...
    */
    ...
    /**
    Returns an arraylist of Post objects representing the posts made by the account holder.
    @return an arraylist of Post objects representing the posts made by the account holder
    */
    ...
    */
    ...
    /**  
    Returns an arraylist of Account objects representing the accounts followed by the account holder.
    @return an arraylist of Account objects representing the accounts followed by the account holder
    */
    ...
    */
    ...
    /**
    Returns an arraylist of Account objects representing the accounts following the account holder.
    @return an arraylist of Account objects representing the accounts following the account holder
    */
    ...
    */
    ...
    /**
    Returns an arraylist of Message objects representing the messages received by the account holder.
    @return an arraylist of Message objects representing the messages received by the account holder
    */
    ...
    */
    ...
    /**
    Returns an arraylist of Message objects representing the messages sent by the account holder.
    @return an arraylist of Message objects representing the messages sent by the account holder
    */
    ...
    */
    ...
    /**
    Returns an arraylist of Account objects representing the accounts blocked by the account holder.
    @return an arraylist of Account objects representing the accounts blocked by the account holder
    */
    public ArrayList<Account> getBlocked_Users(){
    ...
    */
                ...
                if(account_.getPost_number() == 0){
                    ...
                    for(int i=0; i<account_.getPost_number(); i++){
                        ...
                        if(account_.getPost().get(i).getLike_number() == 0){
                            ...
                            for(int j = 0; j<account_.getPost().get(i).getLike_number(); j++){
                        ...
                        if(account_.getPost().get(i).getComment_number() == 0){
                            ...
                            for(int j = 0; j<account_.getPost().get(i).getComment_number(); j++){
    ...
    /**
     * Blocks the given account and adds it to the blocked users arraylist
     *
